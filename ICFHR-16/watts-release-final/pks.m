...
%opts.path_datasets = '/lustre/kartik/Bentham2/';
opts.path_datasets = 'datasets/';
% Path where the generated files will be saved
opts.pathData = '/data4/kartik/labpc_save/ICFHR-16/watts-release/';
% Select the dataset
if nargin < 1
    dataset = 'IAM';
end
...
opts.pathImages = '/lustre/kartik/Bentham/Page_Train_Val/';
opts.pathImages = '/data4/kartik/Datasets/IAM/forms/';
%opts.pathImages = 'datasets/GW/images/'; 
...
opts.levels = [2 3 4 5 6 7 8 9 10];
opts.levelsB = [2 3 4 5 6];
opts.numBigrams = 50;
...
opts.TestCCA = 1;
opts.CCA.Dims = [200];%[96,128,200];
opts.CCA.Reg = [1e-4]; %[1e-4,1e-5,1e-6];
opts.CCA.verbose = 0;

opts.TestKCCA = 0;
opts.KCCA.M = [2500];
opts.KCCA.G = [40];
opts.KCCA.Dims = [200];%[100,120,140,160,180,200,220];
opts.KCCA.Reg = [1e-5];
...
elseif strcmp(opts.dataset,'Bentham')
    opts.minH = 80;
    opts.maxH = 80;
end
