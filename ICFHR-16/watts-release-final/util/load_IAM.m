...
file=['/users/kartik/ICFHR-16/watts-release-final/datasets/IAM/forms.gtp']; %opts.pathDataset
fid = fopen(file, 'r');
...
fileQueries=['/users/kartik/ICFHR-16/watts-release-final/datasets/IAM/queries/queries.gtp'];
